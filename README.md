...
- [AsyncParticles](https://modrinth.com/project/asyncparticles) `21.1.3.1`
- [Aurae!](https://modrinth.com/project/aurae) `1.1.0-neoforge-1.21`
- [Axiom](https://modrinth.com/project/axiom) `5.4.2`
- [Azimuth API](https://modrinth.com/project/azimuth-api) `1.4.3`
- [Balm](https://modrinth.com/project/balm) `21.0.64+neoforge-1.21.1`
...
- [Chat Heads](https://modrinth.com/project/chat-heads) `0.15.3`
- Chimes `Chimes-v2.1.1-1.21.1-NeoForge` (curseforge)
- [Client Sort](https://modrinth.com/project/clientsort) `2.2.2+1.21.1`
...
- [Contraption Lights (Bi-directional Dynamic Lights)](https://modrinth.com/project/contraption-lights) `1.3.1`
...
- [Create: Aeroworks](https://modrinth.com/project/create-aeroworks) `1.4.1+mc1.21.1`
- [Create: Bits 'n' Bobs](https://modrinth.com/project/create-bits-n-bobs) `2.1.15-beta`
- [Create: Coasters Simulated](https://modrinth.com/project/create-coasters-simulated) `0.1.2`
...
- [Envelope](https://modrinth.com/project/envelope) `0.7.2`
...
- [Exposure Catalog](https://modrinth.com/project/exposure-catalog) `1.1.2`
...
- [Highlight](https://modrinth.com/project/highlight) `3.0.0`
...
- [Just Enough Items (JEI)](https://modrinth.com/project/jei) `19.43.0.392`
...
- [Moonlight Lib](https://modrinth.com/project/moonlight) `1.21.1-3.3.0`
...
- [Nondirectional Damage Tilt Fix](https://modrinth.com/project/nondirectionaldamagetiltfix) `3.0.0`
...
- [Reliable Recipes](https://modrinth.com/project/reliable-recipes) `3.1.3-1.21.1-neoforge`
- [Reliable Remover](https://modrinth.com/project/reliable-remover) `2.11.2-1.21.1-neoforge`
...
- [Resourcify](https://modrinth.com/project/resourcify) `1.8.5`
...
- [Sawmill](https://modrinth.com/project/universal-sawmill) `1.21-1.8.0`
...
- [Separate Sable Render Distance (Create Aeronautics Addon)](https://modrinth.com/project/ssrd) `1.8.5`
- [Shoulder Surfing Reloaded](https://modrinth.com/project/shoulder-surfing-reloaded) `1.21.1-5.0.9+neoforge`
...
- [Simple Voice Chat](https://modrinth.com/project/simple-voice-chat) `neoforge-1.21.1-2.6.21`
...
- [Sodium](https://modrinth.com/project/sodium) `mc1.21.1-0.8.13-beta.1-neoforge`
...
- [Swing Through Grass](https://modrinth.com/project/swing-through-grass) `1.0.1`
...
- [yyz's backpack](https://modrinth.com/project/yyzs-backpack) `0.0.3-reborn+1.21.1`
